...
module.exports = function() {
  var libencrypt = ffi.Library('./libtweetnacl', {
    ...
    'crypto_verify_16': ['int', [u8Ptr, u8Ptr]],
    'crypto_verify_32': ['int', [u8Ptr, u8Ptr]],
    'core': [sv, [u8Ptr, u8Ptr, u8Ptr, u8Ptr, 'int']],
    'crypto_core_salsa20': ['int', [u8Ptr, u8Ptr, u8Ptr, u8Ptr]],
    'crypto_core_hsalsa20': ['int', [u8Ptr, u8Ptr, u8Ptr, u8Ptr]],
    'crypto_stream_salsa20_xor': ['int', [u8Ptr, u8Ptr, u64Ptr, u8Ptr, u8Ptr]],
    'crypto_stream_salsa20': ['int', [u8Ptr, u64Ptr, u8Ptr, u8Ptr]],
    'crypto_stream': ['int', [u8Ptr, u64Ptr, u8Ptr, u8Ptr]],
    'crypto_stream_xor': ['int', [u8Ptr, u8Ptr, u64Ptr, u8Ptr, u8Ptr]],
    'add1305': [sv, [u32Ptr, u32]],
    'crypto_onetimeauth': ['int', [u8Ptr, u8Ptr, u64Ptr, u8Ptr]],
    'crypto_onetimeauth_verify': ['int', [u8Ptr, u8Ptr, u64Ptr, u8Ptr]],
    ...
    'pow2523': [sv, [gfPtr, gf]],
    'crypto_scalarmult': ['int', [u8Ptr, u8Ptr, u8Ptr]],
    'crypto_scalarmult_base': ['int', [u8Ptr, u8Ptr]],
    'crypto_box_keypair': ['int', [u8Ptr, u8Ptr]],
    'crypto_box_beforenm': ['int', [u8Ptr, u8Ptr, u8Ptr]],
    'crypto_box_afternm':  ['int', [u8Ptr, u8Ptr, u64Ptr, u8Ptr, u8Ptr]],
    'crypto_box_open_afternm': ['int', [u8Ptr, u8Ptr, u64Ptr, u8Ptr, u8Ptr]],
    'crypto_box': ['int', [u8Ptr, u8Ptr, u64Ptr, u8Ptr, u8Ptr, u8Ptr]],
    'crypto_box_open': ['int', [u8Ptr, u8Ptr, u64Ptr, u8Ptr, u8Ptr, u8Ptr]],
    'crypto_hashblocks': ['int', [u8Ptr, u8Ptr, u64Ptr]],
    'crypto_hash': ['int', [u8Ptr, u8Ptr, u64Ptr]],
    ...
    'reduce': [sv, [u8Ptr]],
    'crypto_sign': ['int', [u8Ptr, u64Ptr, u8Ptr, u64Ptr, u8Ptr]],
    // 'unpackneg': ['int', [gfArrayPtr, u8]],
    'crypto_sign_open': ['int', [u8Ptr, u64Ptr, u8Ptr, u64Ptr, u8Ptr]]
  })
